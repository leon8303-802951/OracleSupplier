...
{   
    ...
    public class OracleEmployeeIncludeAssignmentsCollection
    {
        [JsonProperty("items")]
        public OracleEmployeeAssignment[] Items { get; set; }
        ...
        [JsonProperty("links")]
        public OracleEmployeeAssignmentLink[] Links { get; set; }
    }

    public class OracleEmployeeAssignment
    {
        ...
        public OracleEmployeeAsignmentAssignment[] Assignments { get; set; }

        [JsonProperty("links")]
        public OracleEmployeeAssignmentLink[] Links { get; set; }
    }

    public class OracleEmployeeAsignmentAssignment
    {
    ...
    public class OracleEmployeeAssignmentLink
    {
        [JsonProperty("rel")]
        ...
        public OracleEmployeeAssignmentProperties Properties { get; set; }
    }

    public class OracleEmployeeAssignmentProperties
    {
